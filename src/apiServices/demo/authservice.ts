...
export default class AuthService {
    ...
    static ajax(credentials: any) {
        ...
        const restOpt = { headers: { "Authorization": "Basic " + btoa(credentials.username + ":" + credentials.password) } };
        return axios.get(restUrl, restOpt).then(this.onLogin200, this.onLogin4xx).catch(this.onLogin5xx);
    }
